...
struct reginfo ov5640_init_data[] =
{
////	OV5640 : VGA 640*480
	{0x3008, 0x42},
	{0x3103, 0x03},
...
int ov5640_write(u16 reg_addr, u8 *write_buf)
{
	return Iic0WriteData16(reg_addr, write_buf, 1);
}

/* write a array of registers  */
void sensor_write_array(struct reginfo *regarray)
{
	int i = 0;
