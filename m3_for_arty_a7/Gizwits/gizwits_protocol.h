...
* @{
*/
#define PRODUCT_KEY "c676d41b1ece4439a25b724cac1b75ff"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "67332b4901a447e5b4d521217f41bfb5"
               
/**@name Device status data reporting interval
* @{
*/
#define REPORT_TIME_MAX 500 // 500ms
/**@} */    
...
typedef struct {
  uint8_t valueCar_read[10];
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
  uint8_t flagCar_read:1;
} dataPointFlags_t;
